...
public class Main_Testing {
    public static void main(String[] args){
        ...
        userDataAccessObject = new FileUserDataAccessObject("./newusers.csv", "mealplan.csv", new CommonUserFactory());
        ...
        System.out.println(userDataAccessObject.accounts.get(1).getName());
        System.out.println(userDataAccessObject.accounts.get(1).getPassword());
