...
public class LoginViewTest {
    ...
    LoginView loginView;
    private final String userDataFilePath = "./test_users.csv";
    ...
    public void testLogInSuccess() {
        ...
        loginViewModel.getState().setPassword("TestPassword");
        loginView.logIn.doClick();
        assertEquals("TestUser", loginViewModel.getState().getUsername());
        assertEquals("TestPassword", loginViewModel.getState().getPassword());
